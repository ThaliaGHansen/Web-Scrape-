...
# Set Executable Path & Initialize Chrome Browser just like it was done in jupyter notebook 
...
def featured_image(browser):
   ...
   # Use Base URL to Create Absolute URL
    ...
    return featured_image_url_full
...
def hemisphere(browser):
    ...
    for item in range(len(links)):
        ...
        hemisphere["featured_image_url"] = sample_element["href"]
...
def scrape_hemisphere(html_text):
    ...
    hemisphere = {
        "title": title_element,
        "featured_image_url": sample_element
    }
    return hemisphere
